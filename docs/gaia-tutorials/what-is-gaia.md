...
`ochain` is the name of the Cosmos SDK application for the Cosmos Hub. It comes with 2 main entrypoints:

- `ochaind`: The Gaia Daemon and command-line interface (CLI). runs a full-node of the `ochain` application.
